...
\end{center}
‎در ابتدا لازم می‌دانم از جناب آقای دکتر رامتین خسروی که در انجام این پژوهش  افتخار استفاده از راهنمایی ایشان را داشتم، تشکر و قدردانی کنم. مطمئناً این کار بدون کمک‌های همه‌جانبه و بی‌شائبه‌ی ایشان امکان‌پذیر نبود.
...
\thispagestyle{plain}
\input{2-Preliminaries/Preliminaries}
\chapter{پژوهش‌های مرتبط}
\label{chapter:RelatedWork}
\thispagestyle{plain}
\input{3-RelatedWork/RelatedWork}
\chapter{طراحی بر اساس تبادل ناهمگام پیغام}
\label{chapter:proposedFramework}
\thispagestyle{plain}
\input{4-ProposedFramework/ProposedFramework}
\chapter{ارزیابی}
