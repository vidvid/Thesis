\newglossaryentry{اکتور}{name={اکتور}, description={\lr{actor}}}
\newglossaryentry{مدل اکتور}{name={مدل اکتور}, description={\lr{actor model}}}
...
\newglossaryentry{همگام‌سازی}{name={همگام‌سازی}, description={\lr{synchronization}}}
\newglossaryentry{هماهنگی}{name={هماهنگی}, description={\lr{coordination}}}
\newglossaryentry{شی‌ء}{name={شی‌ء}, description={\lr{object}}}
\newglossaryentry{ریسمان}{name={ریسمان}, description={\lr{thread}}}
\newglossaryentry{ریسمان-بنیان}{name={ریسمان-بنیان}, description={\lr{thread-based}}}
...
\newglossaryentry{بررسی گونه}{name={بررسی گونه}, description={\lr{type checking}}}
...
\newglossaryentry{رویداد-بنیان}{name={رویداد-بنیان}, description={\lr{event-based}}}
\newglossaryentry{مجری رویداد}{name={مجری رویداد}, description={\lr{event handler}}}
\newglossaryentry{پشته}{name={پشته}, description={\lr{stack}}}
...
\newglossaryentry{تعویض متن}{name={تعویض متن}, description={\lr{context switch}}}
\newglossaryentry{وارونگی کنترل}{name={وارونگی کنترل}, description={\lr{inversion of control}}}
\newglossaryentry{مسدود کننده}{name={مسدود کننده}, description={\lr{blocking}}}
\newglossaryentry{استثناء}{name={استثناء}, description={\lr{exception}}}
\newglossaryentry{تقسیم-و-حل}{name={تقسیم-و-حل}, description={\lr{devide and conquer}}}
\newglossaryentry{خط لوله}{name={خط لوله}, description={\lr{pipeline}}}
\newglossaryentry{بن‌باز}{name={بن‌باز}, description={\lr{livelock}}}
\newglossaryentry{ترتیبی}{name={ترتیبی}, description={\lr{sequential}}}
\newglossaryentry{موجودیت}{name={موجودیت}, description={\lr{entity}}}
\newglossaryentry{افزایشی}{name={افزایشی}, description={\lr{incremental}}}
\newglossaryentry{آینده}{name={آینده}, description={\lr{Future}}}
\newglossaryentry{توزین بار}{name={توزین بار}, description={\lr{load balancing}}}
\newglossaryentry{توان عملیاتی}{name={توان عملیاتی}, description={\lr{throughput}}}
\newglossaryentry{مخزن}{name={مخزن}, description={\lr{repository}}}
\newglossaryentry{مشتری}{name={مشتری}, description={\lr{client}}}
\newglossaryentry{دسترس‌پذیری}{name={دسترس‌پذیری}, description={\lr{availability}}}
\newglossaryentry{مقیاس‌پذیری}{name={مقیاس‌پذیری}, description={\lr{scalability}}}
